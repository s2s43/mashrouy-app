...
if menu_choice == "📈 قسم الأسهم والتداول (Stock Terminal)":
    ...
    try:
        ...
        st.error(f"🚨 حدث خطأ أثناء تحميل مركز التعميدات: {e}")
    ...
    # شاشة مؤقتة تنبيهية للأقسام الجاري إضافتها بالتدريج
    st.title(f"🛠️ {menu_choice}")
    st.info("هذا القسم تحت الإنشاء والتطوير حالياً. سنقوم بإضافة ملفه الخاص في الخطوات القادمة وفق الخطة.")
